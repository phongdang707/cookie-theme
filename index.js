let a = document.getElementsByClassName("top-banner");
a[0].innerHTML = `<svg
...
<a class="learn-more" href="add.com">Learn more </a>
<div class="btn-ok" onClick="closeShow('top-banner')">OK</div>`;

function closeShow(name) {
  hidden = "hidden";
  let a = document.getElementsByClassName(name);
  a[0].className += ` ${hidden}`;
}
